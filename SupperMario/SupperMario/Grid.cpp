...
void Grid::LoadGrid(vector<LPGAMEOBJECT> ListObj)
{
	float l, t, r, b;
...
void Grid::Insert(LPGAMEOBJECT obj, float x, float y, float w, float h)
{
...
void Grid::PushObjectToCell(LPGAMEOBJECT obj, int grid_row, int grid_column)
{
	if (obj == NULL)
		return;
	//obj->isOnCamera = false;
